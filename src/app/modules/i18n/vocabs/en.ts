  ...
  data: {
    ...
    "AUTH": {
      ...
      REGISTER: {
        ...
        SECTORS: {
          ...
          SOFTWARE: 'Software',
          SATELLITE_AND_SPACE: 'Satellite and Space',
          ENGINEERING: 'Engineering',
          OTHER: 'Other'
        }
      },
      "VALIDATION": {
        SECTOR_REQUIRED: 'Sector selection is required',
    ...
    "CONTACT": {
      "HERO": {
        ...
        "ITEMS": {
          "RESPONSE": {
            "TITLE": "Fast Response",
            "TEXT": "Reach the right team for sales, product and technical questions."
          },
          "API": {
            "TITLE": "API & Integration",
            "TEXT": "Get support for access, usage scenarios and implementation planning."
          },
          "CUSTOM": {
            "TITLE": "Custom Requests",
            "TEXT": "Discuss image processing, regional demand and custom enterprise workflows."
          }
        }
      },
      "FORM": {
        ...
        "PLACEHOLDERS": {
          ...
          "BUSINESS_EMAIL": "name@company.com",
          "SUBJECT": "How can we help you?",
          "MESSAGE": "Tell us about your project, use case or request..."
        },
        "ERRORS": {
          "FULL_NAME_REQUIRED": "Full name is required.",
          "FULL_NAME_MIN": "Minimum 2 characters required.",
          "BUSINESS_EMAIL_REQUIRED": "Business email is required.",
          "BUSINESS_EMAIL_INVALID": "Please enter a valid email address.",
          "SUBJECT_REQUIRED": "Subject is required.",
          "SUBJECT_MIN": "Minimum 3 characters required.",
          "MESSAGE_REQUIRED": "Message is required.",
          "MESSAGE_MIN": "Minimum 10 characters required."
        }
      }
    },
    "API_DOC": {
    ...
    "MAP": {
      ...
      "UPLOAD": {
        ...
        "LOADED_FILE": "Loaded file",
        "FILE_UPLOAD_WARNING": "Only Polygon or MultiPolygon features will be processed. Point and LineString features will be ignored.",
        "FILE_FORMAT_WARNING": 'Unsupported file format. Please upload a ZIP Shapefile, GeoJSON, or KML file.',
        "FILE_READ_ERROR": 'Failed to read the file. Please upload a ZIP Shapefile, GeoJSON, or KML file.',
      },
      "STATE": {
        "LOADING": "Loading",
      ...
      SMART_FILTER: {
        ...
        "SORT": {
          ...
          "AREA_OFF_NADIR_ANGLE": "Nadir Angle"
        },
        METADATA: {
          TITLE: 'Metadata',
          CLOSE: 'Close',
        ...
        FILTER_PANEL: {
          TITLE: 'Filter',
          SUBTITLE: 'Filter satellite images by acquisition and quality values.',
          CLOSE: 'Close filter panel',
          IMAGE_TYPE: 'Image Type',
          START_DATE: 'Start Date',
          END_DATE: 'End Date',
          MIN_CLOUD_RATE: 'Min. Cloud Rate',
          MAX_CLOUD_RATE: 'Max Cloud Rate',
          MIN_OFF_NADIR: 'Min Off Nadir',
          ...
          "PLATFORM": "Platform",
          "CLOUD_RATE": "Cloud Rate",
          "OFF_NADIR": "Nadir Angle"
        },
        REQUEST_PANEL: {
          TITLE: 'New Image Request',
          SUBTITLE: 'Create an image request for the selected area.',
          AOI_AREA: 'Total Image Area',
          IMAGE_TYPE: 'Image Type',
          START_DATE: 'Start Date',
          END_DATE: 'End Date',
          MAX_CLOUD_RATE: 'Max. Cloud Rate',
          MAX_OFF_NADIR: 'Max. Off Nadir Angle',
    ...
    "MESSAGES": {
      ...
      "ADD_TO_CART_WITHOUT_LOGIN_SUCCESS": "Product added to cart successfully. Please log in to view your cart and complete the purchase."
    },
    "FILTERS": "Filters",
    ...
    "ORDER_DETAIL_VIEW": {
      ...
      "NEW_SATELLITE_REQUEST": "New Satellite Imagery Request",
      "READY_SATELLITE_IMAGE": "Ready Satellite Image",
      ...
      "RESOLUTION": "Resolution",
      "ACQUISITION_DATE": "Acquisition Date",
      "CLOUD_RATE": "Cloud Cover",
      "SATELLITE_IMAGE": "Satellite Image",
      "ADDITIONAL_SERVICES": "Additional Services",
      "PROCESSING_OPTIONS": "Image Processing Options",
      "OPTION_COUNT": "options",
      "NO_PROCESSING_OPTIONS": "No image processing option is available for this product.",
      ...
      "COPIED": "Copied",
      "COPY": "Copy",
      "API_KEY_PENDING": "The API key will appear here when the order is completed.",
      "API_SERVICE": "API Service",
      "API_DESCRIPTION": "Keep the API access key assigned to your order secure and use it only in authorized applications.",
      "PROCESSING_SERVICE": "Image Processing Service",
      "ORTHORECTIFICATION": "Orthorectification",
      "PANSHARPENING": "Pansharpening",
      "NDVI_ANALYSIS": "NDVI Analysis",
      "CLASSIFICATION": "Classification",
      "API_SERVICE_DESCRIPTION": "API key and digital service access.",
